...
class GetData {
	...
	public function if_username_exists($username, $email) {
	...
	public function if_username_exists_in_other_users($username, $id_korisnika, $id_admin) {
		$query = "SELECT COUNT(*) FROM admin WHERE username='$username' AND id_korisnika='$id_korisnika' AND id_admin!='$id_admin'";
	...
	public function if_user_mail_exists_in_other_users($email, $id_korisnika, $id_admin) {
		$query = "SELECT COUNT(*) FROM admin WHERE email='$email' AND id_korisnika='$id_korisnika' AND id_admin<>'$id_admin'";
	...
	public function if_project_exists_by_name($project_name) {
		$query = "SELECT COUNT(*) FROM projects WHERE project_name='$project_name' AND status!='0'";
	...
	public function if_project_exists_by_id($project_id) {
		$query = "SELECT COUNT(*) FROM projects WHERE project_id='$project_id' AND status!='0'";
	...
	public function if_website_exists_by_url($where,$url) {
		if($where == "live"){
			$query = "SELECT COUNT(*) FROM live_sites WHERE live_url='$url'";
		}
		elseif ($where == "stage") {
			$query = "SELECT COUNT(*) FROM stage_sites WHERE stage_url='$url'";
		}
	...
	public function get_all_sites($where) {
	...
	public function get_site_by_project_id($where,$project_id) {
		$query = "SELECT * FROM $where WHERE project_id=:project_id";
...
//		return $this->get_fetch_data($query, $stmtArray, "bindValue");
	...
	public function get_number_of_porudzbine($id_korisnika, $where){

		$query = "SELECT COUNT(*) FROM porudzbine WHERE id_korisnika = :id_korisnika $where AND status='1'";
	...
	public function get_porudzbine_by_filter_pag($id_korisnika, $id_magacina, $where, $pag) {
		$query = "SELECT * FROM porudzbine WHERE id_korisnika=:id_korisnika AND id_magacina=:id_magacina $where ORDER BY datum  DESC, id_narudzbine DESC $pag";
